...
{
    public class MoveHandle : MonoBehaviour, IRTHandle
    {
        [FormerlySerializedAs("scaleRation")] [SerializeField] private float scaleRatio = 1;
        ...
        private void DoHandleMove()
        {
            ...
            var resolution = 1;
            handleTarget.position += Vector3.Scale(motionMask, delta) * (resolution * resolutionMultiplier * Time.deltaTime);
