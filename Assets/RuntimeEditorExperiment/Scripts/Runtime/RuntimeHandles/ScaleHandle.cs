...
{
    public class ScaleHandle : MonoBehaviour, IRTHandle
    {
        ...
        private void DoHandleMove()
        {
            ...
            var resolution = 1;
            handleTarget.transform.localScale += Vector3.Scale(motionMask, delta) * (resolution * resolutionMultiplier * Time.deltaTime);
